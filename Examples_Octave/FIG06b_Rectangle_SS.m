...
ps          = 0;        % ps = 1 models pure shear; ps = 0 models simple shear
etaRatio    = 1e-3;     % Viscosity ratio (matrix/inclusion)
a           = 0.2; b = a/2; phi = 60/180*pi; % Parameters defining elliptical inclusion
nout        = 1e3;
% Numerical parameters
nx          = 201;              ny          = nx;                   % Numerical resolution
Lx          = 1;                Ly          = 1;                    % Model dimension
